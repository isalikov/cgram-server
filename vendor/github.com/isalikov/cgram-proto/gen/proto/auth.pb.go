...
type RegisterRequest struct {
	...
	PasswordVerifier  []byte                 `protobuf:"bytes,2,opt,name=password_verifier,json=passwordVerifier,proto3" json:"password_verifier,omitempty"`      // OPAQUE verifier, server never sees plaintext password
	PublicIdentityKey []byte                 `protobuf:"bytes,3,opt,name=public_identity_key,json=publicIdentityKey,proto3" json:"public_identity_key,omitempty"` // Ed25519 public key
...
func (x *RegisterRequest) GetPasswordVerifier() []byte {
	if x != nil {
		return x.PasswordVerifier
	}
	return nil
}

func (x *RegisterRequest) GetPublicIdentityKey() []byte {
	if x != nil {
...
type RegisterResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        string                 `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // server-assigned opaque ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type LoginRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Username      string                 `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"`
	AuthMessage   []byte                 `protobuf:"bytes,2,opt,name=auth_message,json=authMessage,proto3" json:"auth_message,omitempty"` // OPAQUE auth message
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LoginRequest) GetAuthMessage() []byte {
	if x != nil {
...
type LoginResponse struct {
	...
	ServerAuthMessage []byte                 `protobuf:"bytes,2,opt,name=server_auth_message,json=serverAuthMessage,proto3" json:"server_auth_message,omitempty"` // OPAQUE server response
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *LoginResponse) GetServerAuthMessage() []byte {
	if x != nil {
		return x.ServerAuthMessage
	}
	return nil
}
...
const file_proto_auth_proto_rawDesc = "" +
	"\n" +
	"\x10proto/auth.proto\x12\x05cgram\"\x8a\x01\n" +
	"\x0fRegisterRequest\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12+\n" +
	"\x11password_verifier\x18\x02 \x01(\fR\x10passwordVerifier\x12.\n" +
	"\x13public_identity_key\x18\x03 \x01(\fR\x11publicIdentityKey\"+\n" +
	"\x10RegisterResponse\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\"M\n" +
	"\fLoginRequest\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12!\n" +
	"\fauth_message\x18\x02 \x01(\fR\vauthMessage\"d\n" +
	"\rLoginResponse\x12#\n" +
	"\rsession_token\x18\x01 \x01(\tR\fsessionToken\x12.\n" +
	"\x13server_auth_message\x18\x02 \x01(\fR\x11serverAuthMessage\"4\n" +
	"\rLogoutRequest\x12#\n" +
	...
	"\auser_id\x18\x01 \x01(\tR\x06userIdB+Z)github.com/isalikov/cgram-proto/gen/protob\x06proto3"
...
var file_proto_auth_proto_goTypes = []any{
	(*RegisterRequest)(nil),         // 0: cgram.RegisterRequest
	(*RegisterResponse)(nil),        // 1: cgram.RegisterResponse
	(*LoginRequest)(nil),            // 2: cgram.LoginRequest
	(*LoginResponse)(nil),           // 3: cgram.LoginResponse
	(*LogoutRequest)(nil),           // 4: cgram.LogoutRequest
	(*LogoutResponse)(nil),          // 5: cgram.LogoutResponse
	(*ResolveUsernameRequest)(nil),  // 6: cgram.ResolveUsernameRequest
	(*ResolveUsernameResponse)(nil), // 7: cgram.ResolveUsernameResponse
}
