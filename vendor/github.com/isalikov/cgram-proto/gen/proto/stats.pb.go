...
type StatsResponse struct {
	...
	OnlineUsers   uint32                 `protobuf:"varint,2,opt,name=online_users,json=onlineUsers,proto3" json:"online_users,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *StatsResponse) GetTotalUsers() uint32 {
	if x != nil {
		return x.TotalUsers
	}
	return 0
...
func (x *StatsResponse) GetOnlineUsers() uint32 {
	if x != nil {
...
const file_proto_stats_proto_rawDesc = "" +
	"\n" +
	"\x11proto/stats.proto\x12\x05cgram\"\x0e\n" +
	"\fStatsRequest\"S\n" +
	"\rStatsResponse\x12\x1f\n" +
	"\vtotal_users\x18\x01 \x01(\rR\n" +
	"totalUsers\x12!\n" +
	"\fonline_users\x18\x02 \x01(\rR\vonlineUsersB+Z)github.com/isalikov/cgram-proto/gen/protob\x06proto3"
...
var file_proto_stats_proto_goTypes = []any{
	(*StatsRequest)(nil),  // 0: cgram.StatsRequest
	(*StatsResponse)(nil), // 1: cgram.StatsResponse
}
